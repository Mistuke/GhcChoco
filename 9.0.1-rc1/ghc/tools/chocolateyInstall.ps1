...
$binSha256   = '10d5f16f3f611f23f928ac33bd8b9362476f38367560f73835877b2acec4f509'
$variant     = ''
$pp          = Get-PackageParameters
if ($pp['integer-simple']) {
  $variant = '-integer-simple'
  $binSha256 = 'b38d767cab949ee810b44f6a0dfec50bc07b88374393106c3ec4a010e695f064'
}
$baseTarget  = 'ghc-' + $version + '-x86_64-unknown-mingw32'
$target      = $baseTarget + $variant
$url64       = 'https://downloads.haskell.org/~ghc/9.0.1-rc1/' + $target + '.tar.xz'
