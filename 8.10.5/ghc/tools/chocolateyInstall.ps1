...
$binSha256   = '4443d989df4f2680f681a4d8b8db310ce9582d21743984016b0eb0163b0c9998'
$variant     = ''
$pp          = Get-PackageParameters
if ($pp['integer-simple']) {
  #$variant = '-integer-simple'
  #$binSha256 = 'f95db4ed10739cccb3043798621d585f57590a2ab83ca7b8bee5df640bfc2688'
}
$baseTarget  = 'ghc-' + $version + '-x86_64-unknown-mingw32'
$target      = $baseTarget + $variant
$url64       = 'https://downloads.haskell.org/~ghc/8.10.5/' + $target + '.tar.xz'
