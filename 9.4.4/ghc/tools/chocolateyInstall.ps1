...
$binSha256   = '160f9ccee997dab0cfc98b2b761e1972a2bfc47389635ba57e8a0084f7d41aa7'
$variant     = ''
$pp          = Get-PackageParameters
if ($pp['integer-simple']) {
  $variant = '-int_native'
  $binSha256 = 'd4601a8dfde5b812d214789a073603b96bbd5a6a3f8906f3a8500285d7e1f8ab'
}
$baseTarget  = 'ghc-' + $version + '-x86_64-unknown-mingw32'
$target      = $baseTarget + $variant
$url64       = 'https://downloads.haskell.org/~ghc/9.4.4/' + $target + '.tar.xz'
