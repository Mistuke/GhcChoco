$version     = '8.0.2'
$packageName = 'ghc'
$url         = 'http://downloads.haskell.org/~ghc/8.0.2/ghc-8.0.2-i386-unknown-mingw32.tar.xz'
$url64       = 'http://downloads.haskell.org/~ghc/8.0.2/ghc-8.0.2-x86_64-unknown-mingw32.tar.xz'
