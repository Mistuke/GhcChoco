...
$url64       = 'https://downloads.haskell.org/~ghc/8.10.1/ghc-8.10.1-x86_64-unknown-mingw32.tar.xz'
...
Get-ChocolateyWebFile -PackageName $packageName -FileFullPath $tarPath `
    ...
    -Url64bit $url64 -ChecksumType64 sha256 -Checksum64 38a3166ea50cccd5bae7e1680eae3aae2b4ae31b61f82a1d8168fb821f43bd67
