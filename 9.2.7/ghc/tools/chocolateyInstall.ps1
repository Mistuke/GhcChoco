...
$binSha256   = '30b9545a18eeb509dac427415fa1c45c264e09ec6ab0e93c8ec48742cbb90f24'
$variant     = ''
$pp          = Get-PackageParameters
if ($pp['integer-simple']) {
  $variant = '-integer-simple'
  $binSha256 = 'c52358544308d6b165203043e7ae520a5b315e302f839b42ff1dae2192bf66f0'
}
$baseTarget  = 'ghc-' + $version + '-x86_64-unknown-mingw32'
$target      = $baseTarget + $variant
$url64       = 'https://downloads.haskell.org/~ghc/9.2.7/' + $target + '.tar.xz'
