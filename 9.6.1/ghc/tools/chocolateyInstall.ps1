...
$binSha256   = '6121a889839d8b409f082169365bbfb6ed9e6a1f6ff0531d577ef7c2a9a417fb'
$variant     = ''
$pp          = Get-PackageParameters
if ($pp['integer-simple']) {
  $variant = '-int_native'
  $binSha256 = 'bdb2b84225adc7f0459514d3638db00be97223949338bb1852076b4d4518ed90'
}
$baseTarget  = 'ghc-' + $version + '-x86_64-unknown-mingw32'
$target      = $baseTarget + $variant
$url64       = 'https://downloads.haskell.org/~ghc/9.6.1/' + $target + '.tar.xz'
