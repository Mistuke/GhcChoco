...
$binSha256   = 'eb74654419cb646e9d2e362b57f2f81bc9f5231bceb543b14cb0341aedb07fa3'
$variant     = ''
$pp          = Get-PackageParameters
if ($pp['integer-simple']) {
  $variant = '-int_native'
  $binSha256 = '75139c5fba3ee90ea25cd061d4e0a0199f376ea11b1f30acb1b3215d8884e9c7'
}
$baseTarget  = 'ghc-' + $version + '-x86_64-unknown-mingw32'
$target      = $baseTarget + $variant
$url64       = 'https://downloads.haskell.org/~ghc/9.8.1/' + $target + '.tar.xz'
