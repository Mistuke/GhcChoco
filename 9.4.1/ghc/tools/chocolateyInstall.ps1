...
$binSha256   = 'fdc2d78b8a978e712a4edcc1628e36a36be736d8202107d2d61999ac7a9dc5d0'
$variant     = ''
$pp          = Get-PackageParameters
if ($pp['integer-simple']) {
  $variant = '-int_native'
  $binSha256 = '6aa125379a8db5a0544049a33673bf86b02c8819c2a2008e4a93ac240d427ed4'
}
$baseTarget  = 'ghc-' + $version + '-x86_64-unknown-mingw32'
$target      = $baseTarget + $variant
$url64       = 'https://downloads.haskell.org/~ghc/9.4.1/' + $target + '.tar.xz'
