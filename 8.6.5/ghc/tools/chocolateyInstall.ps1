...
$url64       = 'https://downloads.haskell.org/~ghc/8.6.5/ghc-8.6.5-x86_64-unknown-mingw32.tar.xz'
...
Get-ChocolateyWebFile -PackageName $packageName -FileFullPath $tarPath `
    ...
    -Url64bit $url64 -ChecksumType64 sha256 -Checksum64 457024c6ea43bdce340af428d86319931f267089398b859b00efdfe2fd4ce93f
