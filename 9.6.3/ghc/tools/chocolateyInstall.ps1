...
$binSha256   = '0cc0e2d290a87c540268e62cc71f8eced2a24f621beeb524cce61bebf644f064'
$variant     = ''
$pp          = Get-PackageParameters
if ($pp['integer-simple']) {
  $variant = '-int_native'
  $binSha256 = '37134a9285ae5e621cb9eb9ba20ce2592230f63a2619f79f9d302cea4fecf73a'
}
$baseTarget  = 'ghc-' + $version + '-x86_64-unknown-mingw32'
$target      = $baseTarget + $variant
$url64       = 'https://downloads.haskell.org/~ghc/9.6.3/' + $target + '.tar.xz'
