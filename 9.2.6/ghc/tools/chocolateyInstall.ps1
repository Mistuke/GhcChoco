...
$binSha256   = 'bd13aadeeadb3454199eb797961350f0a19275ec74002b2816d1b63093dfd55f'
$variant     = ''
$pp          = Get-PackageParameters
if ($pp['integer-simple']) {
  $variant = '-integer-simple'
  $binSha256 = 'dd169952cfbd0ae88f811b0b7318676ee5b2f037cb8220ff0082c3c94bbc7d05'
}
$baseTarget  = 'ghc-' + $version + '-x86_64-unknown-mingw32'
$target      = $baseTarget + $variant
$url64       = 'https://downloads.haskell.org/~ghc/9.2.6/' + $target + '.tar.xz'
