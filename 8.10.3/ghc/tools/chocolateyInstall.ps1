...
$url64       = 'https://downloads.haskell.org/~ghc/8.10.3/ghc-8.10.3-x86_64-unknown-mingw32.tar.xz'
...
Get-ChocolateyWebFile -PackageName $packageName -FileFullPath $tarPath `
    ...
    -Url64bit $url64 -ChecksumType64 sha256 -Checksum64 927a6c699533a115cd49772ef2c753d9af2c13bf9f0b2d3bd13645cc6a144ee3 
