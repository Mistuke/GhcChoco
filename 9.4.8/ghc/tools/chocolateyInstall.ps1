...
$binSha256   = 'c4a767218551210521c78ddb51bfb309b0e336eef21eba1cc076f3bc0cc99a00'
$variant     = ''
$pp          = Get-PackageParameters
if ($pp['integer-simple']) {
  $variant = '-int_native'
  $binSha256 = '24d643fcedae99a6d08709605914e4b8e4eecf1d62c3044239a1cd61fe679e8a'
}
$baseTarget  = 'ghc-' + $version + '-x86_64-unknown-mingw32'
$target      = $baseTarget + $variant
$url64       = 'https://downloads.haskell.org/~ghc/9.4.8/' + $target + '.tar.xz'
