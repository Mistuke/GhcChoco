...
$binSha256   = '3acbe3fc0faa68fa4bf0cc324212956c234c21d7ffd80221cf6caf28726f8227'
$variant     = ''
$pp          = Get-PackageParameters
if ($pp['integer-simple']) {
  $variant = '-int_native'
  $binSha256 = 'e5267e340da903be81a55f12d63637ed5c493b6d5232bb87149ae4bf420ae0dd'
}
$baseTarget  = 'ghc-' + $version + '-x86_64-unknown-mingw32'
$target      = $baseTarget + $variant
$url64       = 'https://downloads.haskell.org/~ghc/9.4.2/' + $target + '.tar.xz'
