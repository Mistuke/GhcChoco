...
$binSha256   = 'a6815804606ef2d99250078d5c1315b74bb5718d8f15a629f211bcd37bad07c3'
$variant     = ''
$pp          = Get-PackageParameters
if ($pp['integer-simple']) {
  $variant = '-integer-simple'
  $binSha256 = '6d5713138149db02dd121c09825f2f278a86471fbd7f7d320627184d8ffbe532'
}
$baseTarget  = 'ghc-' + $version + '-x86_64-unknown-mingw32'
$target      = $baseTarget + $variant
$url64       = 'https://downloads.haskell.org/~ghc/9.2.5/' + $target + '.tar.xz'
